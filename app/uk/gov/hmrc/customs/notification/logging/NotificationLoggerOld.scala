...
import uk.gov.hmrc.customs.notification.logging.LoggingHelperOld.{formatDebug, formatError, formatInfo}
...
*/
@Singleton
class NotificationLoggerOld @Inject()(logger: CdsLogger) {
