...
import uk.gov.hmrc.customs.notification.logging.LoggingHelperOld
import uk.gov.hmrc.http.HeaderCarrier
import uk.gov.hmrc.play.test.UnitSpec
import util.RequestHeaders.{LoggingHeaders, LoggingHeadersWithAuth, LoggingHeadersMixedCase}
import util.TestData._

class LoggingHelperOldSpec extends UnitSpec {
  ...
  "LoggingHelper" should {
    ...
    "format ERROR" in {
      LoggingHelperOld.formatError(errorMsg) shouldBe s"[conversationId=eaca01f9-ec3b-4ede-b263-61b626dde231][fieldsId=ffff01f9-ec3b-4ede-b263-61b626dde232] $errorMsg"
    }

    "format ERROR with headers" in {
      LoggingHelperOld.formatError(errorMsg, LoggingHeaders) shouldBe s"[conversationId=eaca01f9-ec3b-4ede-b263-61b626dde231][fieldsId=ffff01f9-ec3b-4ede-b263-61b626dde232] $errorMsg"
    }

    "format INFO with HeaderCarrier" in {
      LoggingHelperOld.formatInfo(infoMsg) shouldBe s"[conversationId=eaca01f9-ec3b-4ede-b263-61b626dde231][fieldsId=ffff01f9-ec3b-4ede-b263-61b626dde232] $infoMsg"
    }

    "format INFO with headers" in {
      LoggingHelperOld.formatInfo(infoMsg, LoggingHeaders) shouldBe s"[conversationId=eaca01f9-ec3b-4ede-b263-61b626dde231][fieldsId=ffff01f9-ec3b-4ede-b263-61b626dde232] $infoMsg"
    }

    "format INFO with headers one mixed case" in {
      LoggingHelperOld.formatInfo(infoMsg, LoggingHeadersMixedCase) shouldBe s"[conversationId=eaca01f9-ec3b-4ede-b263-61b626dde231][fieldsId=ffff01f9-ec3b-4ede-b263-61b626dde232] $infoMsg"
    }

    "format DEBUG with HeaderCarrier" in {
      val requestChain = hc.requestChain.value
      LoggingHelperOld.formatDebug(debugMsg) shouldBe
    ...
    "format DEBUG with headers" in {
      LoggingHelperOld.formatDebug(debugMsg, LoggingHeaders) shouldBe
        s"""[conversationId=eaca01f9-ec3b-4ede-b263-61b626dde231][fieldsId=ffff01f9-ec3b-4ede-b263-61b626dde232] $debugMsg
    ...
    "format DEBUG with url and payload" in {
      val requestChain = hc.requestChain.value
      LoggingHelperOld.formatDebug(debugMsg, Some(url), Some(ValidXML.toString())) shouldBe
    ...
    "format DEBUG with url and no payload" in {
      val requestChain = hc.requestChain.value
      LoggingHelperOld.formatDebug(debugMsg, Some(url)) shouldBe
        s"""[conversationId=eaca01f9-ec3b-4ede-b263-61b626dde231][fieldsId=ffff01f9-ec3b-4ede-b263-61b626dde232] $debugMsg url=http://some-url
           |headers=List((X-Request-Chain,$requestChain), (X-CDS-Client-ID,ffff01f9-ec3b-4ede-b263-61b626dde232), (X-Conversation-ID,eaca01f9-ec3b-4ede-b263-61b626dde231))""".stripMargin
    }
    ...
    "format DEBUG with payload and no url" in {
      val requestChain = hc.requestChain.value
      LoggingHelperOld.formatDebug(debugMsg, None, Some(ValidXML.toString())) shouldBe
        s"""[conversationId=eaca01f9-ec3b-4ede-b263-61b626dde231][fieldsId=ffff01f9-ec3b-4ede-b263-61b626dde232] $debugMsg
           |headers=List((X-Request-Chain,$requestChain), (X-CDS-Client-ID,ffff01f9-ec3b-4ede-b263-61b626dde232), (X-Conversation-ID,eaca01f9-ec3b-4ede-b263-61b626dde231))
           |payload=
           |<Foo>Bar</Foo>""".stripMargin
    ...
    "format DEBUG with headers including single overwritten header" in {
      LoggingHelperOld.formatDebug(debugMsg, LoggingHeadersWithAuth) shouldBe
        s"""[conversationId=eaca01f9-ec3b-4ede-b263-61b626dde231][fieldsId=ffff01f9-ec3b-4ede-b263-61b626dde232] $debugMsg
